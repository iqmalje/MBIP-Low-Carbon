...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/penggunaanSemasa_elektrik.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/menu.css" />
    <link
      href="https://fonts.googleapis.com/css?family=Poppins"
      rel="stylesheet"
    />
    <title>Maklumat Bil Penggunaan Semasa - Elektrik</title>
  </head>
  <body>
    <!--TOPBAR-->
    ...
    <div class="consumpTpye-container">
      <div class="selected">Elektrik</div>
    ...
    <!--INSTRUCTION/GUIDE-->
    <div class="guide">
      <div class="guide-header">Penggunaan Elektrik Semasa</div>
      <div class="guide-subheader">
        Mohon merujuk kepada maklumat berikut bagi tujuan pengisian
      </div>
      <img
        src="${pageContext.request.contextPath}/resources/images/guide-elektrik.png"
    ...
    <div class="monthRow">
      ...
      <div>
        ...
        <div class="monthlyDataInput-container">
          ...
          <!--nilai semasa-->
          <div class="rowPadding">Nilai Penggunaan Elektrik Semasa:</div>
